...
// fixes unity bug with gamepad and dropdowns https://gist.github.com/mandarinx/eae10c9e8d1a5534b7b19b74aeb2a665
    ...
    void InputScroll()
    {
        if (m_Selectables.Count > 0)
        {
            if (Gamepad.current != null && (
                //               Gamepad.current.dpad.down.IsPressed() ||  Gamepad.current.dpad.up.IsPressed() ||
                //             Gamepad.current.leftStick.down.IsPressed() || Gamepad.current.leftStick.up.IsPressed() 
                Gamepad.current.dpad.IsActuated() ||
